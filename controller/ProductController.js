...
async function updateRecord(req, res) {
    try {
        ...
        if (data) {
            ...
            data.maincategoryId = req.body.maincategoryId ?? data.maincategoryId
            data.subcategoryId = req.body.subcategoryId ?? data.subcategoryId
            data.brandId = req.body.brandId ?? data.brandId
